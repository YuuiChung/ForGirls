                ...
                <form action="forder_save.action" method="post">
	                <div class="person-check check">
	                    ...
	                    <div class="person-checkinner">
	                        ...
	                        <div>
	                        	<label>区域邮编:</label>
	                        	<input type="text" name="post" value="1588888" />
	                        </div>
	                        <div>
	                        	<label>配送地址:</label>
	                        	<input type="text" name="address" value="广州天河区......." />
	                        </div>
	                    </div>
	                </div>
	                <!-- 卖家留言 -->
	                <div class="person-check check">
	               		<h1>卖家留言</h1>
	                	<textarea style="margin: 5px;" name="remark" cols="120" rows="2">周六周日配送</textarea>
		                <div class="submit">
